...
class SetGesturewindow(QWidget):
    def __init__(self,username):
        ...
        self.cb1.addItems(["Open Notepad","Open Chrome","Open cmd","Turn on sleep mode"])
        self.cb1.show()
        self.cb2 = QComboBox(self)
        self.cb2.move(150, 140)
        self.cb2.addItems(["Open Notepad", "Open Chrome","Open cmd","Turn on sleep mode"])
        self.cb2.show()
        self.cb3 = QComboBox(self)
        self.cb3.move(150, 200)
        self.cb3.addItems(["Open Notepad", "Open Chrome","Open cmd","Turn on sleep mode"])
        self.cb3.show()
        self.cb4 = QComboBox(self)
        self.cb4.move(150, 260)
        self.cb4.addItems(["Open Notepad", "Open Chrome","Open cmd","Turn on sleep mode"])
        self.cb4.show()
    ...
    def save(self):
        ...
        self.fst=self.cb3.currentText()
        self.ron=self.cb4.currentText()
